# @title CREDIT Process
# This code is taken from https://github.com/ustunb/actionable-recourse/tree/master/recourse and modified for our purposes.
...
# input vars
raw_data_dir = '/Users/asifahmed/Documents/Codes/MyModelProject/datasets/raw/'
processed_data_dir = '/Users/asifahmed/Documents/Codes/MyModelProject/datasets/processed/'
data_name = 'credit'
raw_data_file = '%s/%s_raw.csv' % (raw_data_dir, data_name)
processed_file = '%s/%s_processed.csv' % (processed_data_dir, data_name)
...
# print(raw_df[monetary_features])
...
processed_df['NoDefaultNextMonth'] = 1 - raw_df['default payment next month']
# processed_df['NoDefaultNextMonth'].replace({1.0:1, 0.0:-1}, inplace=True)

# Gender (male = 1, female = 2)
# processed_df['Female'] = raw_df['SEX'] == 2

# Married (1 = married; 2 = single; 3 = other)
# processed_df['Married'] = 5
processed_df['Married'] = raw_df['MARRIAGE'] == 1
# # processed_df['Single'] = raw_df['MARRIAGE'] == 2
# processed_df['Married'].replace({1:1, bool(0):-1}, inplace=True)
